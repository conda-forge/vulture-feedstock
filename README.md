...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5433&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/vulture-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `vulture` can be installed with `conda`:
...
```
mamba install vulture
```

It is possible to list all of the versions of `vulture` available on your platform with `conda`:
...
```
mamba search vulture --channel conda-forge
```
...
mamba repoquery search vulture --channel conda-forge

# List packages depending on `vulture`:
mamba repoquery whoneeds vulture --channel conda-forge

# List dependencies of `vulture`:
mamba repoquery depends vulture --channel conda-forge
```
